    ...
    return (
        <div className="mushroom-card bg-light rounded-20 column jc-center slightly-faded">
            <div className="row jc-space-between w-100 mw-100 mc-top-row">
                <div className="ultra text-dark align-self-center mc-mushroom-name">{props.mushroom.shroomname}</div>
                <img className="mushroom-card-image" src={props.mushroom.imgsrc} alt="mushroom"/>
            </div>
