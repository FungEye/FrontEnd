...
describe("<OverviewPage />", () => {
  ...
  it("Empty Grows Collapsible", () => {
    ...
    cy.get(".collapse-content")
      .eq(0)
      .should("contain", "You have no Active Grows yet!");
  });
  ...
  it("Empty Boxes Collapsible", () => {
    ...
    cy.get(".collapse-content")
      .eq(1)
      .should("contain", "You have no Boxes yet!");
  });

  it("Overview Page Component: Check Yields", () => {
    mountPage();
    cy.get("#past-yields").click();
    cy.get(".inside-collapsible")
      .last()
      .should("contain", "To see your yields, go to your Yields page.");
  });
});
